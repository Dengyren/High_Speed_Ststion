...
function renderLegend() {
    drawLegend(COLOR.MACHINE.TYPE_A, 25, '东莞');
    drawLegend(COLOR.MACHINE.TYPE_B, 50, '清远');
    drawLegend(COLOR.MACHINE.TYPE_C, 75, '广州');
    drawLegend(COLOR.MACHINE.TYPE_D, 100, '中山');
    drawLegend(COLOR.MACHINE.TYPE_E, 125, '佛山');
    drawLegend(COLOR.MACHINE.TYPE_F, 150, '珠海');
    drawLegend(COLOR.MACHINE.TYPE_G, 175, '深圳');
}

function drawLegend(pointColor, pointY, text) {
    var ctx = $("#layer03_left_01 canvas").get(0).getContext("2d");
    ctx.beginPath();
    ctx.arc(25, pointY, 6, 0, 2 * Math.PI);
...
function renderLayer03Right() {
    ...
    drawLayer03Right($("#layer03_right_chart03 canvas").get(0), "#FF5809", 0.34);
}
...
function renderLayer04Left() {
    ...
    myChart.setOption({
        ...
        legend: {
            ...
            orient: 'vertical',
            data: [
                { name: '全自动收费', icon: 'circle' },
                { name: '半自动收费', icon: 'circle' },
                { name: '人工收费', icon: 'circle' },
            ]
        },
        grid: {
            left: '3%',
        ...
        series: [
            ...
            },
           {
                ...
                data: [120, 382, 251, 204, 170, 200, 140]
            },
        ]
    }
    );
